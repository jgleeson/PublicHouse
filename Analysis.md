Analysing the PublicHouse dataset
================
James Gleeson
...
out some basic analysis. It also includes the R code used to carry out
the analysis, so you can re-create or adapt the charts.
...
contribution to an increase in dwellings per person. And unsurprisingly,
...
At the city level, there were no cases of shrinking populations. The
fastest growth in urban populations was generally in the
Central/Northern European cities, and the lowest in Southern European
cities (including Paris). Only in East Asia did cities consistently
manage to grow their housing stock faster than their population.
...
trend than the data for Ireland.

With those caveats, this chart does reveal some striking general
patterns. In particular, there has on average been no increase in the
amount of housing per person in the Anglophone countries since the start
of the 1980s, while there has been a significant (but slowing) increase
in Southern Europe, and increases over time (though quite unsteady after
2000) in Central/Northern Europe and East Asia.
...
and compares that to the England trend. Broadly speaking, England
started out with more housing per person than the international average,
but has ended up with less.
...
dwellings per 1,000 population. Whereas dwellings per (1,000) people is
a measure of *stock*, this is a measure of *flow*, and it is not
affected by either the previous size of the stock or by the change in
population (at least not very much). So countries that are building a
lot of homes relative to their population can ‘look good’ by this
measure even if that new supply isn’t actually enough to keep up with
population growth.
...
And finally, here’s the aggregate trend for all countries compared to
England. The long-term international trend is downwards, though there
are fairly few observations in the early years of the dataset. Except
for one brief point in the late 1980s, England has had lower net housing
