## PublicHouse
PublicHouse bundles together publicly available data on the number of dwellings and people in cities and countries around the world. The [dataset](https://github.com/jgleeson/PublicHouse/blob/main/dataset.csv) was compiled by [James Gleeson](https://github.com/jgleeson), Housing Research and Analysis Manager at the Greater London Authority. [This note](https://github.com/jgleeson/PublicHouse/blob/main/Analysis.md) sets out some initial analysis of the data.
